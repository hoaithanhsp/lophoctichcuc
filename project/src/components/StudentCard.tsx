      ...
      <div className="progress-container">
        ...
        {progress.pointsNeeded > 0 ? (
          <p className="progress-text">
            {student.total_points}/{student.total_points + progress.pointsNeeded} - Còn {progress.pointsNeeded} điểm lên {LEVEL_CONFIG[Object.keys(LEVEL_CONFIG)[Object.keys(LEVEL_CONFIG).indexOf(student.level) + 1] as keyof typeof LEVEL_CONFIG]?.name}
          </p>
        ) : (
